...
async function runAllMigrations() {
  try {
    ...
    // 1. Confessions tabloları
    console.log('\n📝 Confessions tabloları oluşturuluyor...');
    await pool.query(`
    ...
    // 2. Friend suggestions tabloları
    console.log('\n👥 Friend suggestions tabloları oluşturuluyor...');
    await pool.query(`
    ...
    // 3. Push notification tabloları
    console.log('\n🔔 Push notification tabloları oluşturuluyor...');
    await pool.query(`
    ...
    // 4. Analytics tabloları
    console.log('\n📊 Analytics tabloları oluşturuluyor...');
    await pool.query(`
